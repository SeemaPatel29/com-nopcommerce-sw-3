...
//        1.2 Mouse Hover on “Cell phones” and click
        mouseHoverToElementAndClick(By.xpath("(//a[text()='Cell phones '])[1]"));
...
//        2.8 Change quantity to 2
        ...
        sendTestToElement(By.xpath("//input[@id='product_enteredQuantity_20']"), "2");
...
//        2.20 Fill the mandatory fields
        sendTestToElement(By.name("FirstName"), "Rajesh");
        sendTestToElement(By.name("LastName"), "Patel");
        sendTestToElement(By.xpath("//input[@id='Email']"), "rhspatel8234@gmail.com");
        sendTestToElement(By.name("Password"), "rspt123");
        sendTestToElement(By.id("ConfirmPassword"), "rspt123");
...
//        2.27 Fill the Mandatory fields
        ...
        sendTestToElement(By.id("BillingNewAddress_City"), "London");
        sendTestToElement(By.id("BillingNewAddress_Address1"), "20, Coventry Road");
        sendTestToElement(By.id("BillingNewAddress_ZipPostalCode"), "CV2 0LL");
        sendTestToElement(By.id("BillingNewAddress_PhoneNumber"), "06767567634");
        ...
        sendTestToElement(By.id("CardholderName"), "Sita , Gita");
        //Enter card number
        sendTestToElement(By.id("CardNumber"), "5555 5555 5555 4444");
        //Select Expiry Month
        selectByVisibleTextFromDropDown(By.id("ExpireMonth"), "04");
        //Select Expiry Year
        selectByVisibleTextFromDropDown(By.id("ExpireYear"), "2026");
        //Card code
        sendTestToElement(By.id("CardCode"), "123");
